...
import { Eye, EyeOff, Mail, Lock, User, Phone, MapPin, ChefHat, Users } from "lucide-react"
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      toast({
        ...
        description: "Welcome to MealMate! Your account has been created successfully.",
      })
        ...
        <Card className="shadow-2xl border-0">
          <CardHeader className="text-center pb-8">
            <motion.div
              ...
              className="mx-auto bg-orange-500 p-3 rounded-full w-16 h-16 flex items-center justify-center mb-4"
            >
